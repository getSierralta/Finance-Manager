...
public class AccountTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        //Simulating a categories.txt file containing (in this order):
    ...
    public void testAccount1() {
        ...
        assertEquals(0.0, acc.getCurrentBalance(), 0.001);
    ...
    public void testAccount2() throws Exception {
        ...
        assertEquals("", acc.additionalInfo());
        assertEquals(3900.0, acc.getCurrentBalance(), 0.001);
    ...
    public void testAddStatementLine() {
        ...
        assertEquals(1542, a1.getCurrentBalance(), 0.001);
    ...
    @Test
    public void testAutoCategorizeStatements1() throws Exception {
