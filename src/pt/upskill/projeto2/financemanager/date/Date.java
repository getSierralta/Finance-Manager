...
//	}
    ...
    public static Month stringToMonth(String month) {
        switch (month.toUpperCase()){
            case "JANUARY":
                return Month.values()[1];
            case "FEBRUARY":
                return Month.values()[2];
            case "MARCH":
                return Month.values()[3];
            case "APRIL":
                return Month.values()[4];
            case "MAY":
                return Month.values()[5];
            case "JUNE":
                return Month.values()[6];
            case "JULY":
                return Month.values()[7];
            case "AUGUST":
                return Month.values()[8];
            case "SEPTEMBER":
                return Month.values()[9];
            case "OCTOBER":
                return Month.values()[10];
            case "NOVEMBER":
                return Month.values()[11];
            case "DECEMBER":
                return Month.values()[12];
            default:
